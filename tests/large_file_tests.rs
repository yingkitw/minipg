...
fn test_large_grammar_10mb() {
    let grammar = generate_large_grammar(1); // Reduced to 1MB for faster testing
...
fn test_large_grammar_100mb() {
    let grammar = generate_large_grammar(5); // Reduced to 5MB for faster testing
    let parser = GrammarParser::new();
...
fn test_large_grammar_1gb() {
    let grammar = generate_large_grammar(10); // Reduced to 10MB for faster testing
    let parser = GrammarParser::new();
...
fn test_deeply_nested_grammar() {
    let grammar = generate_deep_nesting_grammar(50); // Reduced to avoid stack overflow
    let parser = GrammarParser::new();
...
fn test_very_deeply_nested_grammar() {
    let grammar = generate_deep_nesting_grammar(100); // Reduced to avoid stack overflow
    let parser = GrammarParser::new();
...
fn test_long_identifiers() {
    let grammar = generate_long_identifiers_grammar(1000); // Reduced for faster testing
    let parser = GrammarParser::new();
...
fn test_very_long_identifiers() {
    let grammar = generate_long_identifiers_grammar(10000); // Reduced for faster testing
    let parser = GrammarParser::new();
...
fn test_large_grammar_from_file() {
    ...
    // Generate and write a 5MB grammar file (reduced from 50MB)
    let grammar = generate_large_grammar(5);
...
fn test_memory_efficiency() {
    // Parse multiple grammars sequentially (reduced sizes)
    for size in [1, 2, 3] {
